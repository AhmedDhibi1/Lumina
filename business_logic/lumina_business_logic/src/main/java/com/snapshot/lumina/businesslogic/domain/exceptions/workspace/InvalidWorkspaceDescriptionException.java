...
public class InvalidWorkspaceDescriptionException extends RuntimeException {
    private final String invalidValue;
    private final InvalidWorkspaceDescriptionException.ValidationReason reason;

    public InvalidWorkspaceDescriptionException(String invalidValue, InvalidWorkspaceDescriptionException.ValidationReason reason) {
        super(buildMessage(invalidValue, reason));
        this.invalidValue = invalidValue;
        this.reason = reason;
    }

    private static String buildMessage(String invalidValue, InvalidWorkspaceDescriptionException.ValidationReason reason) {
    ...
    public InvalidWorkspaceDescriptionException.ValidationReason getReason() {
        return reason;
    }
